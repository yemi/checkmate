...
var fromDateTime = function (v) {
    return Data_Function_Uncurried.runFn7($foreign.fromDateTimeImpl)(Data_Date.year(v.value0))(Data_Enum.fromEnum(Data_Date_Component.boundedEnumMonth)(Data_Date.month(v.value0)))(Data_Date.day(v.value0))(Data_Time.hour(v.value1))(Data_Time.minute(v.value1))(Data_Time.second(v.value1))(Data_Time.millisecond(v.value1));
};
var fromDate = function (d) {
    return Data_Function_Uncurried.runFn7($foreign.fromDateTimeImpl)(Data_Date.year(d))(Data_Enum.fromEnum(Data_Date_Component.boundedEnumMonth)(Data_Date.month(d)))(Data_Date.day(d))(Data_Bounded.bottom(Data_Time_Component.boundedHour))(Data_Bounded.bottom(Data_Time_Component.boundedMinute))(Data_Bounded.bottom(Data_Time_Component.boundedSecond))(Data_Bounded.bottom(Data_Time_Component.boundedMillisecond));
};
var eqDateTime = new Data_Eq.Eq(function (x) {
    return function (y) {
        return Data_Eq.eq(Data_Time_Duration.eqMilliseconds)(x)(y);
    };
});
var ordDateTime = new Data_Ord.Ord(function () {
    ...
    return function (y) {
        return Data_Ord.compare(Data_Time_Duration.ordMilliseconds)(x)(y);
    };
});
